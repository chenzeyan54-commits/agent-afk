...
- **INV-023** (2026-09-22, 9e37173b): GrantManager interface must live in agent/tools/ layer, not cli/ — agent layer must not import cli/ for its own type definitions (#1856)
