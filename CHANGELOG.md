...
### Changed
- consolidate session builders into shared builder (#2059) (2f5102fd)
...
### Fixed
- guard surrogate-pair boundary in shell-task excerpt truncation (#1734) (9c184aff)
- trace-completeness benchmark test improvements (#1726) (8741f890)
- guard ToolLaneFlash onRepaint callback against throws (#1718) (ffff6a87)

### Changed
- consolidate legacy __BUILTIN_WORKTREE_PRUNE__ compat shim (#1736) (bdc01061)
- add coverage for sort order, limit boundaries, escape stripping (#1707) (4340199b)
- freeze time in eviction exact-boundary test (#1716) (194577a5)
- fix mid-sequence scenario description in trace-completeness benchmark (#1727) (7facd4af)
...
### Fixed
- regenerate env-registry docs and harden test cleanup (#1522) (#1525) (d00d8f18)
...
### Added
- extract costTokenParts into shared component (#1401) (#1409) (7b418e8a)
...
### Fixed
- thread topic opts into auto-subscribe watch output (#1023) (#1125) (d651192f)
...
### Changed
- reduce nesting depth in executeBatch (#1074) (#1099) (2d95f20a)
...
### Added
- emit a blocked-on-human marker while an elicitation waits (#718) (ad596c8)
...
### Fixed
- emit hook_decision for silently-denied tool calls, attribute blocks to forks (#714) (2ec5df1)
